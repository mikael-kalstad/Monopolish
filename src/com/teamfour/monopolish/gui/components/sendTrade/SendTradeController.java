package com.teamfour.monopolish.gui.components.sendTrade;
...
public class SendTradeController {
    ...
    @FXML public void initialize() {
        ...
        sendBtn.setOnAction(event -> {
            ...
            // Show message popup
            MessagePopupController.show("Send was successful. Let's hope that " + SEND_USERNAME + " sends something back.", "house.png", "Bank");
