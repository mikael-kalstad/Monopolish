package com.teamfour.monopolish.gui.components.propertyActions;
...
/**
 * Controller class for dialog to property. Will handle all logic when buying houses, hotels and pawning properties.
 */
