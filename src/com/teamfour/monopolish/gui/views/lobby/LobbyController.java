package com.teamfour.monopolish.gui.views.lobby;
...
public class LobbyController {
    ...
    public void createNewLobby() {
        // Input colors
        final String INPUT_COLOR_NORMAL = "white";
        final String INPUT_COLOR_REQUIRED = "orange";
    ...
    private void updateLobbyElements(Pane container) {
        ...
        final String STATUS_FULL = "LOBBY FULL";
        final String STATUS_STARTING = "STARTING";
        final String STATUS_STARTED = "IN GAME";
