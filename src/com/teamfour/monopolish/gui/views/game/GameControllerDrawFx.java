...
public class GameControllerDrawFx {
     ...
     */
    public static Pane createSpecialCard(String title, String logoPath, String info, String backgroundColor) {
     ...
     */
    public static boolean drawHouse(GridPane housegrid, Street street) {
