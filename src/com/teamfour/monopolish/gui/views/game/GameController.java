package com.teamfour.monopolish.gui.views.game;
...
import com.teamfour.monopolish.gui.components.cards.ChanceCardController;
import com.teamfour.monopolish.gui.components.chat.ChatController;
...
public class GameController {
     ...
     */
    public static void refreshBuyHouseDialog() {
        addElementToContainer(ViewConstants.PROPERTY_DIALOG.getValue(), Handler.getBuyHouseContainer());
    }
    ...
    public void initialize() {
        ...
        Handler.getSceneManager().getWindow().setOnCloseRequest(e -> {
            ...
            Alert alertDialog = FxUtils.display(
     ...
     * <li>2. Winner of the game if game is finished, or there is only you left in the game</li>
     * </ul>
     */
    private void startRequestTimer() {
        ...
        TimerTask requestTask = new TimerTask() {
            ...
            public void run() {
                ...
                // 2. Check if there is any winner
                ...
                else if (Handler.getLobbyDAO().getUsersInLobby(Handler.getLobbyDAO().getLobbyId(USERNAME)).size() == 1) {
                    Platform.runLater(() -> announceWinner(USERNAME));
                }
    ...
    private void showProperties(String username) {
        ...
        for (Property p : game.getEntities().getPlayer(username).getProperties()) {
            ...
            if (username.equals(USERNAME)) {
                card.setOnMouseClicked(event -> {
                    ...
                    addElementToContainer(ViewConstants.PROPERTY_DIALOG.getValue(), buyHouseContainer);
                });
            }
        ...
        sendBtn.setOnMouseClicked(e -> {
            if (Handler.getCurrentGame().getPlayers()[Handler.getCurrentGame().getCurrentTurn()].equals(USERNAME)) {
                ...
                addElementToContainer(ViewConstants.SEND_TRADE.getValue(), tradeContainer);
            } else {
