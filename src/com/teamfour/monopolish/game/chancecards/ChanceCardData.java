...
public class ChanceCardData {
    private static ChanceCard[] data = new ChanceCard[]{
            ...
            new ChanceCardBank("'Microsoft' called to warn you about some awful virus on your computer, you should have know something was up with that accent. Total cost $2500.", "file:res/gui/cards/bug.png", -2500),
            ...
            new ChanceCardPlayers("You did not like your opponents, so you stole $600 from each and everyone.", "file:res/gui/cards/stealing.png", 600),
            new ChanceCardPlayers("You wrecked the cars to the other players, pay everyone $900 for mechanical repair fees.", "file:res/gui/cards/crash.png", -900)
    };
